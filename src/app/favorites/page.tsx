      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex-1">
        ...
        {isLoading ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="bg-gray-900/40 rounded-xl overflow-hidden border border-white/5 animate-pulse">
          ...
          <div className="text-center py-20 text-gray-500">
            ...
            <Link href="/catalog">
              <Button className="mt-4 bg-white hover:bg-gray-200 text-black">
                Explorar Catálogo
              </Button>
            </Link>
          </div>
